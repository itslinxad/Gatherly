...
$show_add_venue = isset($_GET['from_my_venues']) || $current_page === 'add-venue.php';
?>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto flex flex-col">
            ...
            <nav class="flex-1 space-y-1">
                <a href="manager-dashboard.php"
                    class="flex items-center px-4 py-3 rounded-lg group <?php echo $current_page === 'manager-dashboard.php' ? 'text-white bg-green-600' : 'text-gray-700 hover:bg-green-50 hover:text-green-600'; ?> transition-colors">
                    <i class="fas fa-home w-5 text-center mr-3"></i>
                    <span class="font-medium">Dashboard</span>
                </a>
                <a href="my-venues.php"
                    class="flex items-center px-4 py-3 rounded-lg group <?php echo $current_page === 'my-venues.php' ? 'text-white bg-green-600' : 'text-gray-700 hover:bg-green-50 hover:text-green-600'; ?> transition-colors">
                    <i class="fas fa-building w-5 text-center mr-3"></i>
                    <span class="font-medium">My Venues</span>
                </a>
                <?php if ($show_add_venue): ?>
                    <a href="add-venue.php"
                        class="flex items-center px-4 py-3 rounded-lg group <?php echo $current_page === 'add-venue.php' ? 'text-white bg-green-600' : 'text-gray-700 hover:bg-green-50 hover:text-green-600'; ?> transition-colors">
                        <i class="fas fa-plus-circle w-5 text-center mr-3"></i>
                        <span class="font-medium">Add Venue</span>
                    </a>
                <?php endif; ?>
                <a href="bookings.php"
                    class="flex items-center px-4 py-3 rounded-lg group <?php echo $current_page === 'bookings.php' ? 'text-white bg-green-600' : 'text-gray-700 hover:bg-green-50 hover:text-green-600'; ?> transition-colors">
            ...
            <div class="pt-4 mt-4 border-t border-gray-200">
                <div class="relative">
                    <button id="profile-dropdown-btn"
                        ...
                        <i class="fas fa-user-tie w-5 text-center mr-3 text-green-600"></i>
                    ...
                    <div id="profile-dropdown"
                        ...
                        <a href="profile.php" class="block px-4 py-2 text-gray-700 hover:bg-green-50 transition-colors">
                            <i class="fas fa-user mr-2"></i>Profile
                        </a>
                        <a href="settings.php" class="block px-4 py-2 text-gray-700 hover:bg-green-50 transition-colors">
        ...
        <div class="container px-4 mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-12 sm:h-16">
                ...
                <div class="items-center hidden gap-6 md:flex">
                    <a href="manager-dashboard.php"
                        class="transition-colors <?php echo $current_page === 'manager-dashboard.php' ? 'font-semibold text-green-600' : 'text-gray-700 hover:text-green-600'; ?>">Dashboard</a>
                    <a href="my-venues.php"
                        class="transition-colors <?php echo $current_page === 'my-venues.php' ? 'font-semibold text-green-600' : 'text-gray-700 hover:text-green-600'; ?>">My Venues</a>
                    <?php if ($show_add_venue): ?>
                        <a href="add-venue.php"
                            class="transition-colors <?php echo $current_page === 'add-venue.php' ? 'font-semibold text-green-600' : 'text-gray-700 hover:text-green-600'; ?>">Add Venue</a>
                    <?php endif; ?>
                    <a href="bookings.php"
                    ...
                    <div class="relative">
                        <button id="profile-dropdown-btn"
                            class="flex items-center gap-2 text-gray-700 transition-colors cursor-pointer hover:text-green-600">
            ...
            <div id="mobile-menu" class="hidden pb-4 md:hidden">
                <div class="flex flex-col space-y-2">
                    <a href="manager-dashboard.php"
                        class="px-4 py-2 transition-colors rounded-lg <?php echo $current_page === 'manager-dashboard.php' ? 'font-semibold text-green-600 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">Dashboard</a>
                    <a href="my-venues.php"
                        class="px-4 py-2 transition-colors rounded-lg <?php echo $current_page === 'my-venues.php' ? 'font-semibold text-green-600 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">My Venues</a>
                    <?php if ($show_add_venue): ?>
                        <a href="add-venue.php"
                            class="px-4 py-2 transition-colors rounded-lg <?php echo $current_page === 'add-venue.php' ? 'font-semibold text-green-600 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">Add Venue</a>
                    <?php endif; ?>
                    <a href="bookings.php"
