...
$venues_query = "
    SELECT v.venue_id, v.venue_name, l.city, l.province, v.capacity, p.base_price, v.description,
           v.suitable_themes, v.venue_type, v.ambiance, v.image
    FROM venues v 
...
$locations_query = "SELECT DISTINCT l.city FROM locations l JOIN venues v ON l.location_id = v.location_id WHERE v.availability_status = 'available' ORDER BY l.city";
            ...
            <div id="venuesContainer" class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mb-6">
                <?php if ($venues_result && $venues_result->num_rows > 0): ?>
                    <?php while ($venue = $venues_result->fetch_assoc()): ?>
                        ...
                        ?>
                        <div class="overflow-hidden transition-shadow bg-white border border-gray-200 shadow-sm rounded-xl hover:shadow-md venue-card flex flex-col"
                            data-name="<?php echo htmlspecialchars($venue['venue_name']); ?>"
                            data-location="<?php echo htmlspecialchars($venue['city']); ?>"
                            ...
                            <div class="relative">
                                <img src="../../../src/services/get-venue-image.php?venue_id=<?php echo $venue['venue_id']; ?>"
                                    alt="<?php echo htmlspecialchars($venue['venue_name']); ?>"
                            ...
                            <div class="flex flex-col flex-1 p-6">
                                ...
                                <div class="flex items-center mb-3 text-gray-600">
                                    ...
                                    <span class="text-sm"><?php echo htmlspecialchars($venue['city']); ?></span>
                                </div>
