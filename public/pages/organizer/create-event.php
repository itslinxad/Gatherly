                            ...
                            <div class="p-6 mb-6 bg-white shadow-lg rounded-2xl">
                                ...
                                <div class="mt-4">
                                    <button type="button" id="chooseOtherVenueBtn"
                                        class="inline-flex items-center px-4 py-3 font-medium text-indigo-600 transition-all duration-200 bg-indigo-100 rounded-lg hover:bg-indigo-200 hover:shadow-md transform hover:-translate-y-0.5">
                                            ...
                                            <tbody id="servicesTableBody">
                                                ...
                                                <tr class="service-row border-b border-gray-100 hover:bg-indigo-50 transition-all duration-200 cursor-pointer hover:shadow-sm"
                                                    ...
                                                    <td class="px-4 py-3 text-center">
                                                        <button type="button"
                                                            class="add-service-btn px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-all duration-200 transform hover:scale-105 hover:shadow-md active:scale-95">
                    ...
                    if (formData.selectedServices && formData.selectedServices.length > 0) {
                        ...
                        formData.selectedServices.forEach(service => {
                            ...
                            selectedRow.innerHTML = `
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <button type="button" class="remove-service-btn px-3 py-1 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 transition-all duration-200 transform hover:scale-105 hover:shadow-md active:scale-95">
