            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-8">
                ...
                <div class="p-6 bg-white shadow-md rounded-xl">
                    <div class="text-center">
                        <div
                            class="flex items-center justify-center w-24 h-24 mx-auto mb-4 text-4xl text-white bg-green-600 rounded-full">
                        ...
                        <span
                            class="inline-block px-3 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-full">
                            <i class="mr-1 fas fa-user-tie"></i>Venue Manager
                        </span>
                    </div>
                ...
                <div class="space-y-6 lg:col-span-2">
                    ...
                    <div class="p-6 bg-white shadow-md rounded-xl">
                        <h2 class="mb-4 text-xl font-bold text-gray-800">
                            <i class="mr-2 text-green-600 fas fa-user-edit"></i>
